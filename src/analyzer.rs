...
impl AnalysisData {
    ...
    fn get_ancestors(&mut self, address: &usize) -> slice::Iter<usize> {
        self.ancestors.get(address).map(|a| a.iter()).unwrap_or([].iter())
    }
}
...
fn analyse_path(rom: &Box<[u8]>, data: &mut AnalysisData, todo: Todo) -> Result<Vec<Todo>, String> {
    ...
    loop {
        ...
        match instruction {
            ...
            Instruction::RST_00H => {
                result.push(Todo { start_address: 0x00, return_address: Some(next_address) });
            ...
            Instruction::RST_08H => {
                result.push(Todo { start_address: 0x08, return_address: Some(next_address) });
            ...
            Instruction::RST_10H => {
                result.push(Todo { start_address: 0x10, return_address: Some(next_address) });
            ...
            Instruction::RST_18H => {
                result.push(Todo { start_address: 0x18, return_address: Some(next_address) });
            ...
            Instruction::RST_20H => {
                result.push(Todo { start_address: 0x20, return_address: Some(next_address) });
            ...
            Instruction::RST_28H => {
                result.push(Todo { start_address: 0x28, return_address: Some(next_address) });
            ...
            Instruction::RST_30H => {
                result.push(Todo { start_address: 0x30, return_address: Some(next_address) });
            ...
            Instruction::RST_38H => {
                result.push(Todo { start_address: 0x38, return_address: Some(next_address) });
